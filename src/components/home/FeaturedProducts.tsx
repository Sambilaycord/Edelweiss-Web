...
import { ChevronDown, Star, Image as ImageIcon, Loader2, ShoppingCart } from 'lucide-react';
...
const FeaturedProducts: React.FC<FeaturedProductsProps> = ({
  ...
  return (
    <>
      <section id="products" className="py-10 max-w-7xl mx-auto px-4">
                ...
                <div className="mt-auto pt-3 border-t border-gray-50 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <button
                      ...
                      className="p-2 text-gray-700 hover:text-black hover:scale-110 cursor-pointer transition-all"
