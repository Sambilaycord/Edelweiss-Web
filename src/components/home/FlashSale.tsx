...
const FlashSale: React.FC<FlashSaleProps> = ({ products }) => {
  ...
  return (
    <>
      <section className="relative group pt-2">
        <div className="flex items-center justify-between mb-6">
          ...
          <a href="#" className="text-gray-600 font-medium hover:underline">View All</a>
        </div>
          ...
          {products.map((p) => {
            ...
            return (
              <div
                ...
                className="w-[calc((100%-16px)/2)] sm:w-[calc((100%-32px)/3)] md:w-[calc((100%-48px)/4)] lg:w-[calc((100%-64px)/5)] flex-shrink-0 bg-white border border-gray-100 rounded-xl overflow-hidden hover:shadow-lg transition-all duration-300 flex flex-col cursor-pointer hover:-translate-y-1"
              >
                <div className="relative h-48 w-full bg-gray-50 flex items-center justify-center overflow-hidden">
                  ...
                  <span className="absolute top-2 left-2 bg-red-600 text-white text-[10px] font-bold px-2 py-1 rounded shadow-sm uppercase">
                    -40% OFF
                  </span>
                </div>
                ...
                <div className="p-4">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 bg-pink-600 text-white py-2 rounded-lg text-sm font-medium hover:bg-pink-600 transition-colors"
                  >
      ...
      {selectedProduct && (
        <QuickAddModal
          ...
          basePrice={selectedProduct.price * 0.6}
